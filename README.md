...
[![Version](https://img.shields.io/badge/version-1.3.28-orange?style=flat-square)](./package.json)
...
App version comes from `package.json` (currently **1.3.28**). It appears on the login screen and in the signed-in UI. On load, ProxPanel compares against GitHub and can show an update banner.
